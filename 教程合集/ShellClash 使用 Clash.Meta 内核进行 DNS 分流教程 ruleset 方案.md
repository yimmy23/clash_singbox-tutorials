...
```
curl -o $clashdir/yamls/user.yaml -L https://cdn.jsdelivr.net/gh/DustinWin/clash-tutorials@main/dns-bypass/ruleset-mode/redir-host-user.yaml && $clashdir/start.sh restart
```
# 二、 诀窍
