...
0 4 * * * curl -o /data/clash/yamls/user.yaml -L https://cdn.jsdelivr.net/gh/DustinWin/clash-ruleset@main/shellclash-userconfig/fake-ip-user.yaml && /data/clash/start.sh restart >/dev/null 2>&1 #每天早上 4 点更新 user.yaml
...
<img src="https://github.com/DustinWin/clash-tutorials/assets/45238096/c9874384-befc-40c2-ac71-fb880e39a555" width="60%"/>
