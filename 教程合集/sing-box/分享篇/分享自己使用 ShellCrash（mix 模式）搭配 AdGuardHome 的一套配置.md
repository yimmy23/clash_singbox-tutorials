...
202#curl -o /data/ShellCrash/jsons/dns.json -L https://cdn.jsdelivr.net/gh/DustinWin/ruleset_geodata@sing-box-config/ruleset-dns-lite.json && /data/ShellCrash/start.sh restart >/dev/null 2>&1#更新dns.json
