...
我们可以进入 [MetaCubeX/meta-rules-dat/meta/geo](https://github.com/MetaCubeX/meta-rules-dat/tree/meta/geo) 后在左侧“Go to file”搜索框内分别搜索“bilibili”和“acfun”，显然可以**精确搜索到结果**，但仅在“geo/geosite/”内有，那么就可以这样编写：
- 注：以下只是节选，请酌情套用
